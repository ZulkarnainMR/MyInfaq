...
use App\Filament\Admin\Resources\KeteluasanResource\Pages;
        ...
        return $form->schema([
            Forms\Components\Section::make('Laporan Agihan')->schema([
                ...
                Forms\Components\TextInput::make('bilangan_penerima')
                    ...
                    ->numeric()
                    ->minValue(0)
                    ->helperText('Jumlah orang / keluarga yang menerima manfaat.')
                    ->validationMessages([
                        'numeric' => 'Sila masukkan nombor sahaja.',
                        'min' => 'Bilangan penerima tidak boleh kurang daripada 0.',
                    ]),
                Forms\Components\Textarea::make('keterangan_penerima')
                    ...
                    ->rows(4)
                    ->columnSpanFull()
                    ->helperText('Perincikan siapa penerima bantuan ini (contoh: 50 buah keluarga asnaf di Kampung X).')
                    ->validationMessages([
                        'required' => 'Sila masukkan keterangan mengenai penerima sumbangan.',
                    ]),
            ...
            Forms\Components\Section::make('Keputusan Audit')->schema([
                ...
                Forms\Components\Textarea::make('nota_audit')
                    ->label('Nota Audit')
                    ->rows(3)
                    ->helperText('Sebarang nota tambahan atau sebab penolakan laporan agihan ini.'),
            ])->columns(2),
        ]);
    }
